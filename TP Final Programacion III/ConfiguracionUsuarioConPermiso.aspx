<%@ Page Title="Configuración" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConfiguracionUsuarioConPermiso.aspx.cs" Inherits="TP_Final_Programacion_III.ConfiguracionUsuarioConPermiso" %>
    ...
    <div class="container-fluid config-workspace px-0 pt-2">
        ...
        <div class="config-hero d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
            ...
            <div class="config-security-chip">
                ...
                <span><strong>Cuenta protegida</strong><small>Acceso con gestión</small></span>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-9 config-content">
                ...
                <asp:Panel
                    ...
                    <div class="card border-0 shadow-sm config-card">
                        ...
                        <div class="card-header bg-white p-4">
                            <h2 class="h5 fw-bold mb-1">Imagen de perfil
                            </h2>
